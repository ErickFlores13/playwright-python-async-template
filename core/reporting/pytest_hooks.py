...
def pytest_runtest_makereport(item, call):
    ...
    if rep.when == "call" and rep.failed:
        ...
        try:
            ...
            allure.attach(
                screenshot_bytes, name="failure_screenshot", attachment_type=AttachmentType.PNG
            )
            ...
            allure.attach(html_content, name="page_html", attachment_type=AttachmentType.HTML)
