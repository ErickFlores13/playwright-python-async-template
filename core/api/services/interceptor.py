...
class InterceptorService:
    ...
    async def after_response(
        self, response: APIResponseWrapper, request_context: Dict[str, Any]
    ) -> APIResponseWrapper:
        """
    ...
    def _log_response(self, response: APIResponseWrapper, context: Dict[str, Any]) -> None:
        """
    ...
    def _record_metrics(self, response: APIResponseWrapper, context: Dict[str, Any]) -> None:
        """
    ...
    async def _run_interceptor(self, interceptor: Callable, *args) -> Any:
        """
